...
public class Tarea3Tests extends BaseTests {
    ...
    public void ejercicio2Test() {
        Logs.info("Hacer tap en DEG (parte superior izquierda)");
        Gestures.tap(driver.findElement(AppiumBy.id("com.google.android.calculator:id/mode")));
    ...
    public void ejercicio3Test() {
        ...
        Gestures.tap(driver.findElement(AppiumBy.accessibilityId("pi")));
    ...
    public void ejercicio4Test() {
        ...
        Gestures.tap(String.format("%d!=", numeroAleatorio));
    ...
    public void ejercicio5Test() {
        ...
        Gestures.tap(String.format("%d+%d=", numeroAleatorio1, numeroAleatorio2));
    ...
    public void ejercicio6Test() {
        ...
        Logs.info("Escribimos el Nro usando tap");
        Gestures.tap(String.valueOf(numeroAleatorio));

        Logs.info("Hacer doble tap donde está escrito el número para seleccionarlo");
        Gestures.doubleTap(driver.findElement(AppiumBy.id("com.google.android.calculator:id/formula")));

        Logs.info("Hacemos tap en el boton de borrar");
        Gestures.tap(driver.findElement(AppiumBy.accessibilityId("delete")));
    ...
    public void ejercicio7Test() {
        ...
        Logs.info("Hacemos long tap en el boton de borrar");
        Gestures.longTap(driver.findElement(AppiumBy.accessibilityId("delete")));
    ...
    public void ejercicio8Test() {
        ...
        final var canvas = driver.findElement(AppiumBy.id("com.google.android.calculator:id/drag_layout"));

        Logs.info("Realizamos el swipe vertical");
        Gestures.swipeVertical(50, 5, 90, canvas);
